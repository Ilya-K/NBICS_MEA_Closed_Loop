...
// This class is modified from class CRawFileReader to apprehend MultiChannelDevice MCD DataFiles.

namespace MEAClosedLoop
{
  using TRawDataPacket = Dictionary<int, ushort[]>;

  public class CMCDFileReader : IRawDataProvider
  {
    ...
    // Public methods ===================================================================================================
    // Constructor ======================================================================================================
    public CMCDFileReader(string fileName, OnChannelData onChannelData, OnError onError)
    {
      m_fileName = fileName;
    ...
    private void TimerProc(object o1, EventArgs e1)
    {
      ...
      try
      {
        ...
        lock (m_binReader)
        {
          // План
          // для каждого канала
          // читаем m_blockSize данных
          // по одному конвертируем в ushort и возвращаем в массив data
          //
          //
          //
