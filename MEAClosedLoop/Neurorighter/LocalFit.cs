...
//        private TFltData y_threshold;
        ...
        public TFltData[] filter(TFltData[] filtData, List<TStimIndex> stimIndices)
        {
            int bufferLength = filtData.Length;  
            ...
            for (int i = 0; i < PRE + POST; i++)
            {
                ...
                if (i < (PRE + POST) - bufferLength)
                    ...
                    previousData[i] = filtData[i + bufferLength - (PRE + POST)];
            }
